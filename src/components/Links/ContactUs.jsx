...
const ContactUs = () => {
  ...
  const [message, setMessage] = useState('');
    ...
    const mailtoLink = `mailto:contact@merupulu.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(
      `From: ${email}\n\n${message}`
    )}`;
    ...
    <div className="min-h-screen px-4 py-10 text-gray-800">
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="bg-gray-200 p-6 rounded-lg shadow-md space-y-2">
          <p><strong>Email:</strong> <a href="mailto:contact@merupulu.com" className="text-gray-800 dark:text-blue-400">contact@merupulu.com</a></p>
          <p><strong>Website:</strong> <a href="https://news.merupulu.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400">https://news.merupulu.com</a></p>
