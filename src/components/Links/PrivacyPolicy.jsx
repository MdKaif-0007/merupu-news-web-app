    ...
    <div className="min-h-screen px-4 py-10 bg-[#DBDBDB] text-gray-800">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="space-y-6 text-base leading-relaxed">
          <div>
            <h2 className="text-xl font-semibold text-blue-600 mb-1">Information We Collect:</h2>
            <ul className="list-disc list-inside space-y-1">
              <li>Personal data you submit via forms (e.g., name, email)</li>
              <li>Non-personal data like IP address, browser type, and usage statistics through cookies and analytics tools</li>
            </ul>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-blue-600 mb-1">How We Use Your Data:</h2>
            <ul className="list-disc list-inside space-y-1">
          ...
          <div>
            <h2 className="text-xl font-semibold text-blue-600 mb-1">Data Security:</h2>
            <ul className="list-disc list-inside space-y-1">
              <li>We do not share or sell your personal data to third parties</li>
              <li>All data is handled through secure methods using trusted tools like Google Analytics</li>
            </ul>
          </div>

          <div>
            <h2 className="text-xl font-semibold text-blue-600 mb-1">Cookies:</h2>
            <p>
              We use cookies to track anonymous usage patterns and improve functionality. You can manage cookie preferences through your browser settings.
            </p>
          </div>
