          ...
          <div className="mb-12">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <div
                ...
                className="bg-gray-100 w-10 h-10 rounded-full flex items-center justify-center cursor-pointer text-black hover:scale-105 shadow-lg transition-transform"
                title="Native Share"
              >
