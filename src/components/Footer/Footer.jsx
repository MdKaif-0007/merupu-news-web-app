    ...
    <footer className="bg-[#3c3c3c] text-white">
      ...
      <div className="max-w-7xl mx-auto py-10 px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-3">
          <h1 className="text-3xl font-bold text-orange-600">Merupu News</h1>
          <p className="text-sm">Substance of Print, Reach of Digital</p>
          <p className="text-sm">Contact us: <span className="text-orange-500">feedback@merupu.in</span></p>
          <p className="mt-4 font-semibold">FOLLOW US</p>
          <div className="flex space-x-3 mt-2">
            <FaFacebookF className="text-orange-500 text-lg cursor-pointer hover:scale-95" />
            <FaInstagram className="text-orange-500 text-lg cursor-pointer hover:scale-95" />
            <FaLinkedinIn className="text-orange-500 text-lg cursor-pointer hover:scale-95" />
            <FaTelegramPlane className="text-orange-500 text-lg cursor-pointer hover:scale-95" />
            <FaTwitter className="text-orange-500 text-lg cursor-pointer hover:scale-95" />
            <FaYoutube className="text-orange-500 text-lg cursor-pointer hover:scale-95" />
          </div>
        </div>
      ...
      {/* Copyright Strip */}
      <div className="bg-orange-600 py-4 text-center text-sm text-white space-x-4">
